        ...
        <div class="ka-chart">
            <svg width="100%" height="<?php echo $height; ?>" id="ka-chart">
              ...
              <g class="axes-x" text-anchor="start" transform="translate(0, <?php echo $inner_height + 4; ?>)">
                <text fill="#757575" x="<?php echo $padding_left; ?>" y="10" dy="1em" text-anchor="start"><?php echo $date_start->format($dateFormat); ?></text>
                <text fill="#757575" x="100%" y="10" dy="1em" text-anchor="end"><?php echo $date_end->format($dateFormat); ?></text>
              </g>
